...
2. **模式道认可** — 用当前模式道的认可话术（不是泛泛表扬，是该模式道文化下的专业认可）
3. **方法论沉淀** — 自问并输出：
   - 失败的根因是什么？（一句话）
   - 有效的方法是什么？（一句话）
...
当前失败→模式道切换链做了**表层换框**（换谁在说话）。但有些问题不是"说法不对"，而是"想法不对"。
...
## Part 3: 模式道感知的认可话术完整表

| 模式道 | 认可关键词 | 认可话术核心 | 文化根源 |
|------|-----------|------------|---------|
| 🟠 如来佛祖 | 3.75、Owner、闭环 | "这才是 Owner 该有的样子。3.75 打底。" | 复盘 + 结果导向 |
| 🟡 百眼魔君 | ROI、SOP、极致 | "结果到位了。ROI 翻正。" | 数据驱动 + 沉淀 |
| 🔴 菩提祖师 | 凤凰、交账、举杯 | "烧不死的鸟是凤凰。胜则举杯相庆。" | 自我批判 + 军事荣誉 |
| 🟢 太上老君 | 赛马、赛道、灰度 | "赛马跑出来了。你赢了这条赛道。" | 竞争 + 验证 |
| ⚫ 金蝉子 | 基本盘、可依赖 | "基本盘守住了。简单可依赖。" | 技术信仰 |
| 🟣 卷帘大将 | 方案先行、审查三问 | "方案先行。审查三问有具体答案。这才叫交付。" | 三步闭环 |
| 🔵 孙悟空 | 猛将、标准化 | "猛将发于卒伍。做难而正确的事。" | 长期主义 |
| 🟦 哪吒 | 兄弟、正道 | "兄弟该有的执行力。正道成功。" | 结果 + 纪律 |
| 🟧 红孩儿 | 极致、性价比 | "极致！够极致。" | 用户 + 效率 |
| 🟤 猪八戒 | Keeper Test、stunning | "Keeper Test: passed." | 人才密度 |
| ⬛ 牛魔王 | Algorithm、shipped | "Good. Shipped." | 第一性原理 |
