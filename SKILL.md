...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 🔴菩提 | ⬛牛魔王 | ⬜小白龙 | 🔱二郎神 | ⚫金蝉子 | 🔶太白 | 🪟镇元 | 🟡百眼 | 🟠如来 | 🟦哪吒 | 🟢太上 | 🟣沙悟净 | 🟠如来 | 🟧红孩儿 | 🟤猪八戒 | 📌赤脚 | 🟠如来 |
...
| 🟣 沙悟净 | 默认真经·方案先行·影响分析·深挖根因·稳定交付 | 方案驱动→三步工作法→审查三问·P7→P8交付闭环 |
...
| 🟣 沙悟净 | > [🟣 沙悟净味] 默认真经，方案先行。影响分析做了吗？三步工作法走完了吗？审查三问有具体答案吗？ |
...
| 🟣 沙悟净 | > [🟣 沙悟净味] 默认真经，方案先行。影响分析做了吗？三步工作法走完了吗？审查三问有具体答案吗？ | 方案先行 · 三步闭环 |
...
| 🫤 差不多就行 | 颗粒度粗/不闭环 | 📌 赤脚大仙(流程完成≠真实完成) → 🟧 红孩儿(极致专注) → 🟤 猪八戒(不合格就替换) → ⬜ 小白龙(像素级完美) | 先拆自报完成假象→追极致→Keeper Test淘汰→完美交付 |
